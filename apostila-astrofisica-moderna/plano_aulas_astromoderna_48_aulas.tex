...
\ideias{
\item A esfera celeste é uma construção geométrica útil, não uma superfície real.
\item O movimento diário do céu vem da rotação da Terra; o movimento anual aparente do Sol vem da translação terrestre.
\item Modelos astronômicos são avaliados pela capacidade de prever posições, brilhos e espectros.
}
...
\ideias{
\item Declinação é análoga à latitude; ascensão reta é análoga à longitude, medida em horas.
\item O tempo sideral indica quais ascensões retas cruzam o meridiano local.
\item A conversão entre sistemas depende da latitude, da hora e da data.
}
