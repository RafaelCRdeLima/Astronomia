...
\setbeamertemplate{title page}{%
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[
      ...
      inner sep=0pt,
      opacity=0.88
    ] at ([xshift=-0.9cm,yshift=0.25cm]current page.east)
      {\includegraphics[height=0.62\paperheight]{assets/mercury_messenger.png}};
  \end{tikzpicture}
  \vspace{1.2cm}
  \begin{minipage}{0.64\paperwidth}
    {\usebeamerfont{title}\fontsize{25}{30}\selectfont\color{MercuryText}
      O Problema da\\
      Precessão da Órbita\\
      de Mercúrio\par}
    \vspace{0.35cm}
